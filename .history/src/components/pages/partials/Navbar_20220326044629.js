    ...
    return (
        <nav className='Navbar shadow-sm' id='NavBar'>
            ...
            <div className="respNav" id='respNav'>
                <Link to='/' className='resTxt home'>Home</Link>
                <Link to="/about-me"className='resTxt about'>About</Link>
                <Link to='/projects' className='resTxt work'>Projects</Link>
                <Link to='/contact-me' className='resTxt contact'>Contact</Link>
            </div>
        </nav>
    )
}
