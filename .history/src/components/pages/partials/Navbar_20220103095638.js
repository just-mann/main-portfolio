    ...
    return (
        <div className='Navbar'>
            <div className='NavbarContainer'>
                <Link to="/"className="myLogo" onClick={toggleHam}>
                    <h3>justin</h3>
                </Link>
            ...
            <div className="respNav" id='respNav'>
                <Link to='/' className='home' onClick={toggleHam}>Home</Link>
                <Link to="/about-me"className='about' onClick={toggleHam}>About</Link>
                <Link to='/portfolio' className='work' onClick={toggleHam}>Work</Link>
                <Link to='/contact-me' className='contact' onClick={toggleHam}>Contact</Link>
            </div>
        </div>
    )
}
