            ...
            <div className="heroSection">
                ...
                <div className="heroMain">
                    <div className="heroMainLeft">
                        <h3 className='mainHeading'>Hey there, I'm Justin Kollie</h3>
                        ...
                        <Link to='/' className="downloadResumeBtn heroBtn">See Resume</Link>
                        <Link to='/contact-me' className="heroContactBtn heroBtn">Contact Me</Link>
                    </div>
                </div>
            </div>
        </div>
