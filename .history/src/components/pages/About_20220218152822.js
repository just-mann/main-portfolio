            ...
            <section className="aboutContainer">
                <div className="aboutContainer__intro">
                    ...
                    <p className='aboutContainer__description'>
                        My name is Justine (pronounced Justin). I am a self taught events 
                    ...
                    <p className="aboutContainer__description">
                        During the day I am a nursery assistant in an Early Years setting, 
                        and studied for my degree within this sector. 
                        During the weekends I spend my time attending 
