            ...
            <section className="aboutContainer">
                <div className="aboutContainer__intro">
                    ...
                    <p className='aboutContainer__description'>
                        My name is Cazz. I am a self taught events 
                        photographer with a level 5 photography diploma based in Southampton, UK. 
                        I cover many genres in photography including portraiture, sport, special 
                        events such as baby showers and travel.
                    </p>
                    <p className="aboutContainer__description2">
                    During the day I am a nursery assistant in an Early Years setting, and studied for my degree within this sector. During the weekends I spend my time attending different types of events to broaden my photography skills.
                    </p>
